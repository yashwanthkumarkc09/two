...
package ExceptionModule.ExceptionFeature;
import pom.ExceptionPage;
import java.io.File;
...
public class ExceptionTestCase extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new ExceptionPage(driver).Eusername,"balakrishna@opaltechsolutions.com");
        ...
        try
        {
            actions.EnterData(new ExceptionPage(driver).Epassword,"Opal@1234");
        ...
        try
        {
            actions.Click(new ExceptionPage(driver).Elogin);
        ...
        try
        {
            actions.Click(new ExceptionPage(driver).EUpdateButton);
